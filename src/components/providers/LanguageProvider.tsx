...
const translations = {
  uz: {
    ...
    productionSub: 'Xodimlar uchun ovqat pishirishga keladigan mahsulotlar',
  ...
  ru: {
    ...
    productionSub: 'Продукты для питания персонала',
